...
function manageSortList(opt) {
  ...
  if (opt == "popular") {
    divSortList.innerHTML = `<button class="selected" id="selected" aria_labelledby="listboxlabel" aria-haspopup="listbox" aria-label="Populaire">Populaire<i class="fas fa-chevron-down"></i></button>
    ...
    divSortList.innerHTML = `<button class="selected" id="selected" aria_labelledby="listboxlabel" aria-haspopup="listbox" aria-label="Date">Date<i class="fas fa-chevron-down"></i></button>
       <div class="options hidden">  
           <button class="optPopular" role="option" aria-label="Populaire">Populaire</button>
           <button class="optTitle" role="option" aria-label="Titre">Titre</button>
       </div>`;
  } else if (opt == "title") {
    divSortList.innerHTML = `<button class="selected" id="selected" aria_labelledby="listboxlabel" aria-haspopup="listbox" aria-label="Titre">Titre<i class="fas fa-chevron-down"></i></button>
       <div class="options hidden">  
           <button class="optPopular" role="option" aria-label="Populaire">Populaire</button>
           <button class="optDate" role="option" aria-label="Date">Date</button>
       </div>`;
...
function refreshSortList(currentMedias, currentPhotographer, opt) {
  ...
  const mediaFactory = new MediaFactory(currentMedias, currentPhotographer);
  mediaFactory.createMediaCard();
